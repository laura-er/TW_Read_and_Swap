        ...
        <div style={{ position: 'relative' }}>
            <button ref={buttonRef} type="button"
                    ...
                    style={{
                        ...
                        fontFamily: 'inherit', fontWeight: 400, color: 'var(--color-text)',
                        outline: 'none', cursor: 'pointer', whiteSpace: 'nowrap', position: 'relative',
                        minWidth: '130px',
                    }}>
                <span style={{ flex: 1, textAlign: 'left' }}>{selected?.label}</span>
                <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                     style={{ transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 0.15s', color: 'var(--color-text-muted)' }}>
