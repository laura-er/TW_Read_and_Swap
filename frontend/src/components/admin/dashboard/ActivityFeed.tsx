...
const typeLabel: Record<ActivityItem['type'], { label: string; color: string }> = {
    book_added: { label: 'Book Added', color: 'text-blue-500' }, swap_completed: { label: 'Swap Done', color: 'text-green-500' },
    user_joined: { label: 'New User', color: 'text-[var(--color-accent)]' }, report_filed: { label: 'Report', color: 'text-yellow-500' },
