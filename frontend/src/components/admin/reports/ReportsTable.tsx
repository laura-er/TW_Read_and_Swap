                ...
                <table className="w-full text-sm">
                    ...
                    {reports.map((r) => (
                        <tr key={r.id} className="border-t border-[var(--color-border)] hover:bg-[var(--color-surface-alt)]/50 transition-colors">
                            <td className="px-4 py-3"><Badge variant={r.type === 'book' ? 'info' : 'accent'} className="capitalize">{r.type === 'user' ? t.admin.users.slice(0, -1) : t.admin.books.slice(0, -1)}</Badge></td>
