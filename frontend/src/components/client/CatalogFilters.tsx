    ...
    return (
        <div className="mb-8 flex flex-col gap-3">
            <div style={{ display: 'flex', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.06)', border: '1px solid var(--navbar-border)', overflow: 'hidden' }}>
                <CustomDropdown value={selectedGenre} options={GENRES as string[]} getLabel={v => v === 'All' ? t.books.allGenres : v} onChange={onGenreChange} minWidth="120px" />
                ...
                <div style={{ width: '1px', background: 'var(--navbar-border)', flexShrink: 0 }} />
                <CustomDropdown value={selectedCondition} options={CONDITIONS as string[]} getLabel={v => v === 'All' ? t.books.allConditions : v} onChange={onConditionChange} minWidth="130px" />
                <div style={{ width: '1px', background: 'var(--navbar-border)', flexShrink: 0 }} />
