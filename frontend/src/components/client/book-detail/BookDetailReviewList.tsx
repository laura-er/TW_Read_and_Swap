                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <div className="flex items-start justify-between mb-2 gap-4">
                                    <div><p className="text-base font-bold text-(--color-text)">{review.author.name}</p><p className="text-sm text-(--color-text-muted)">{formatRelativeDate(review.createdAt)}</p></div>
